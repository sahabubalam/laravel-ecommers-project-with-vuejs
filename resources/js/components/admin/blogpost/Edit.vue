                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Blogpost</h3></div>
                                <div class="card-body">
                                <form role="form" enctype="multipart/form-data" @submit.prevent="UpdateBlogpost()">
...
<script>
    export default{
       ...
       created()
        {
            axios.get(`/edit-blogpost/${this.$route.params.id}`)
            .then((response)=>{
                this.form.fill(response.data.blogposts)
            })
        },
        computed:
        {
        ...
        methods:
        {
           ...
           UpdateBlogpost()
            {
                this.form.post(`/update-blogpost/${this.$route.params.id}`)
                .then((response)=>{
