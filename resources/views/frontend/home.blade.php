...
<div id="app">
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="{{('assets/front/img/language.png')}}" alt="">
                <div>English</div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> sahabub.cse@gmail.com</li>
                                <li>Free Shipping for all Order of $99</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{asset('assets/front/img/hero/banner.jpg')}}">
                        <div class="hero__text">
                            ...
                            <h2>Electronic <br />100% Organic</h2>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="{{('assets/front/img/payment-item.png')}}" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{('assets/front/js/jquery.slicknav.js')}}"></script>
